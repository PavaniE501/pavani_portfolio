...
// const SiRestapi = dynamic(() => import("react-icons/si").then(mod => mod.SiRestapi), { ssr: false });
...
const SiAndroid = dynamic(() => import("react-icons/si").then(mod => mod.SiAndroid), { ssr: false });
const SiApple = dynamic(() => import("react-icons/si").then(mod => mod.SiApple), { ssr: false });
...
const skills = [
  ...
  { name: "iOS", icon: <SiApple className="text-gray-300" /> },
  { name: "Node.js", icon: <SiNodedotjs className="text-green-500" /> },
  { name: "MongoDB", icon: <SiMongodb className="text-green-400" /> },
  // { name: "RESTful API", icon: <SiRestapi className="text-pink-400" /> },
    ...
    <section className="relative py-24 px-6 md:px-20 text-gray-200 overflow-hidden bg-[#010d0c]">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        >
          ...
          with strong foundations in Redux, MongoDB, RESTful APIs, Jest testing, and modern cloud architecture.
        </motion.p>
